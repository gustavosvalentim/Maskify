...
Element.prototype.maskify = function (mask) {
  ...
  var OPTIONS = options; // Keycodes that will be processed
  ...
  19, // pause/break
  20, // caps lock
  32]; // Special chars that will be considered when inserting masks

  var SPECIALCHARS = ['(', ')', '.', '*', '[', ']', '{', '}', '-', ' ']; // An array including each char of the mask
